...
//------------------------------------------------------------------------
class TeodorSynth3001Processor : public Steinberg::Vst::AudioEffect
{
public:
	TeodorSynth3001Processor ();
	~TeodorSynth3001Processor () SMTG_OVERRIDE;

    // Create function
	static Steinberg::FUnknown* createInstance (void* /*context*/) 
	{ 
		return (Steinberg::Vst::IAudioProcessor*)new TeodorSynth3001Processor; 
	}
